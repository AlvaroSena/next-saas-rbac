...
CREATE UNIQUE INDEX "accounts_provider_user_unique" ON "accounts" USING btree ("provider","user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "invites_email_organization_unique" ON "invites" USING btree ("email","organization_id");--> statement-breakpoint
